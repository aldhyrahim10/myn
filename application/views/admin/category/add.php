                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="panel-body">
                                <form action="<?= site_url('admin/category/add') ;?>" method="POST" enctype="multipart/form-data">
                                    <div class="row mb-2">
                                        <label for="name" class="col-sm-4 col-form-label">Category</label>
                                    <div class="col-sm-8">
                                        <input type="text" name="category" class="form-control" id="category" value="<?= set_value('category');?>"><br>
